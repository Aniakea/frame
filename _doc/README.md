# Frame Documentation Index

状态说明：v4.2 仍为 Draft，M1 和 PoC-A 至 PoC-E 未在文档中声明通过。

文档 | 状态 | 用途
--- | --- | ---
[requirements-v4.2.md](requirements-v4.2.md) | `v4.2-draft` | Frame 当前需求基线、corrected stable domain IDs、验收与 blocker
...
规范冲突顺序：Accepted ADR > v4.2 requirements > v4.2 architecture delta > v4.1 historical document。
