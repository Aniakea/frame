...
- [x] 实机启动记录确认 target、dual core、16 MiB Flash、8 MiB PSRAM 和 exact module marking。（[M1 PASS record M1-002](../../poc/evidence/m1-20260831/M1-PASS-RECORD.md)：boot banner 8/8 on-device 断言；[N16R8 marking 照片](../../poc/evidence/m1-20260831/photos/board_back_module_20260831.jpg) ↔ boot log flash=16777216 / psram=8388608）
...
- [x] 保存 schematic/repository commit、root 与 bundled license inventory。（schematic PDF 与 repository commit 已存于本文 Verified Sources；root 与 bundled license inventory 见 [license inventory](../licenses/INVENTORY.md)，2026-09-07 对 pinned commits 逐项复核）
